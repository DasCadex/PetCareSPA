...
public class OrdenService {
    ...
    public Orden guardarOrdenCompre(Orden nuevaOrden) {
        ...
        Map<String, Object> producto = productoClient.getProductoById(nuevaOrden.getProductoId());//obtienes el id del prodcuto llamando a la clase  y lo guarda y si no existe dara el error 
    ...
    List<Orden> ordenes = ordenRepository.findAll();// esto nos permite calcular el valor de los productos y el precio 
